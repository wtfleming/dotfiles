...
brew install make
# TODO should instead be gnutls ?
brew install texinfo gnutl autoconf
brew install pkg-config

Download src from https://github.com/emacs-mirror/emacs/tags
...
something like
path+=("$HOME/bin/emacs-emacs-29.3/src")
is in .zshrc

For some reason Emacs.app won't start for me when it is built?
Leaving info below to investigate it later
...
from there. The application will be fully self-contained.
...
This doesn't effect ARM macs, and a workaround will probably be in erlang/OTP 27
