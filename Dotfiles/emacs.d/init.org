...
Two separate graphs, each with its own database — they share =~/.emacs.d/org-roam.db=
otherwise and overwrite each other's index. =wiki= is the default; =C-c n G= switches.
