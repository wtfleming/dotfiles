...
it. If the returned report has no closing **Coverage** section, or is missing
any of its five entries, say which rather than filling them in — an unaccounted
read is not a wide one.
