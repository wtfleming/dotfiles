...
- [ ] No path left dead by the change — the code you replaced is gone, or compatibility
      was asked for and that is said
...
- [ ] The commands you ran are reported exactly, with their results — not "tests pass" —
      with credentials scrubbed per `~/.claude/reference/github-publishing.md` before any
      of it goes anywhere public
